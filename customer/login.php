    ...
    <div class="card-body p-md-5">
      <div class="row justify-content-center">
        ...
        <?php
          ...
          <form class="mx-1 mx-md-4" action="<?php echo $_SERVER['PHP_SELF']?>" accept-charset="UTF-8" method="post">
            ...
            <p>
              ...
              <a href="/AP_Assignment/sign_up.php">Đăng kí ngay</a>
            </p>
            <p class="mt-2 mb-2">
              Quên mật khẩu? <a href="/AP_Assignment/auth/forgot_password.php">Lấy lại mật khẩu</a>
            </p>
                <?php 
                    if(!empty($tb)) {
        ...
        <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center justify-content-center order-1 order-lg-2">
          <img style="width: 50%; height: auto;" class="img-fluid rounded" alt="Login image" src="../public/img/logo1.png"/>
        </div>
      </div>
    </div>
  </div>
