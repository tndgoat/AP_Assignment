                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <br>
                            <p style="margin: 0; text-align: justify;">We're happy you signed up for XYZ.</p>
                            <br>
                            <p style="margin: 0; text-align: justify;">To start exploring the XYZ website, please confirm you account with the OTP number below!</p>
                        </td>
                    </tr>
                    <tr>
                        <td align="left" bgcolor="#ffffff">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <h3 style="margin: 0; text-align: justify;">XYZ_ADMIN</h3>
                        </td>
                    </tr>
                </table>
            </td>
                    ...
                    <tr>
                        <td align="center" bgcolor="#e9ecef"
                            ...
                            <p style="margin: 0;">If you are interested in experiencing our website, you can <a
                                    href="http://localhost/AP_Assignment" target="_blank">VISIT</a> it any time.</p>
